import { FlushResponse, IncreaseTimeResponse, LoadL1MessagingContractResponse, SetTimeResponse, PredeployedAccount, L1ToL2MockTxResponse, L2ToL1MockTxResponse } from "../devnet-utils";
...
export interface Devnet {
     ...
     */
    sendMessageToL2: (l2ContractAddress: string, functionName: string, l1ContractAddress: string, payload: Array<number>, nonce: number) => Promise<L1ToL2MockTxResponse>;
    /**
     ...
     */
    consumeMessageFromL2: (l2ContractAddress: string, l1ContractAddress: string, payload: Array<number>) => Promise<L2ToL1MockTxResponse>;
    /**
